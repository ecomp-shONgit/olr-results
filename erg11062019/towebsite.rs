...
"e-codices_fmb-cb-0055_0158v_max"
    ...
    //for namepart in stich2.iter() {
        println!("{}", namepart ); 
        let mut naname = String::from( "0_POI/" );
        naname.push_str( &namepart.to_string( ) );
        naname.push_str( "diffbild.png" );//0_POI
        htmloutput.push_str( "<div>Name: " );
        htmloutput.push_str( &naname );
        htmloutput.push_str( "</div>" );
        htmloutput.push_str( "<img style=\"width:24%;\" src=\"" );
        htmloutput.push_str( &naname );
        htmloutput.push_str( "\"/>\n" );
        
        let mut naname_0 = String::from( "1_rand_traegermaterial/" );
        naname_0.push_str( &namepart.to_string( ) );
        naname_0.push_str( "rand.png" ); //1_
        htmloutput.push_str( "<img style=\"width:24%;\" src=\"" );
        htmloutput.push_str( &naname_0 );
        htmloutput.push_str( "\"/>\n" );
        //
        //
        let mut naname_1 = String::from( "2_thresholding_freistellen/" );
        naname_1.push_str( &namepart.to_string( ) );
        naname_1.push_str( "freigest.png" ); //2_
        htmloutput.push_str( "<img style=\"width:24%;\" src=\"" );
        htmloutput.push_str( &naname_1 );
        htmloutput.push_str( "\"/>\n" );

        let mut naname_2 = String::from( "3_box_line_schmuck/" );
        naname_2.push_str( &namepart.to_string( ) );
        naname_2.push_str( "boxess.png" ); //3_
        htmloutput.push_str( "<img style=\"width:24%;\" src=\"" );
        htmloutput.push_str( &naname_2 );
        ...
        if count % 10 == 0 && count != 0 {
            ...
            htmloutput.push_str( &(count+10).to_string( ) );
